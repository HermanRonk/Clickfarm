    ...
    <div class="container-fluid" id="FirstTab">
        ...
        <div class="row border border-dark rows" id="onderzoek-row">
            ...
            <div class="container col-sm" id="AutoSell-col">
                ...
                <input class="slider" id="SliderOil" type="text" data-provide="slider" data-slider-min="0" data-slider-max="20" data-slider-step="1" data-slider-value="20" onchange="objSalesComputer.showOil(this.value)"
                />
                <div id="autoSellFlour"> </div>
                Actief:
                <input type="checkbox" id="autoFlourCheck" onchange="objSalesComputer.checkFlour(this.checked)">
                <input class="slider" id="SliderFlour" type="text" data-provide="slider" data-slider-min="0" data-slider-max="875" data-slider-step="25" data-slider-value="875" onchange="objSalesComputer.showFlour(this.value)"
                />
                <div id="autoSellPasta"> </div>
                Actief:
                <input type="checkbox" id="autoPastaCheck" onchange="objSalesComputer.checkPasta(this.checked)">
                <input class="slider" id="SliderPasta" type="text" data-provide="slider" data-slider-min="0" data-slider-max="450" data-slider-step="25" data-slider-value="450" onchange="objSalesComputer.showPasta(this.value)"
                />
                ...
                <input class="slider" id="SliderKunststof" type="text" data-provide="slider" data-slider-min="0" data-slider-max="260" data-slider-step="10" data-slider-value="260" onchange="objSalesComputer.showKunststof(this.value)"
                />
